...
if (isset($_POST['submit'])){
    ...
    VALUES ('$A_YEAR', '$dept_id','$p_code','$no_of_students','$no_of_students_late_entry', '$no_of_students_graduted', '$no_of_students_placed', '$no_of_students_higher_studies')";
        ...
        <div class="div">
            <form class="fw-bold" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="dept_id" class="form-control" placeholder="Enter Department ID" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">
                        Program Code
                    </label>
                    <input type="text" name="p_code" class="form-control" placeholder="Enter Count" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">
