...
if (isset($_POST['submit'])){
    ...
    $query="INSERT INTO `program_master`(`DEPT_ID`,`PROGRAM_CODE`, `PROGRAM_NAME`, `DURATION`) 
    VALUES ('$dept_id', '$p_code', '$p_name','$duration')";
        ...
        <div class="div">
            <form class="fw-bold" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="Program_Code" class="form-control" placeholder="Enter Program Code" required>
                </div>
