    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4  primary-text fs-4 fw-bold text-uppercase border-bottom">
                <img src="assets/img/mumbai-university-removebg-preview.png" alt="Logo" height="85px" width="85px"><div>MU NIRF PORTAL</div> </div>
            <div class="list-group list-group-flush my-3">
                ...
                <a href="ResearchStaff.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        ></i>Research  Staff</a>
                <a href="PatentDetailsIndividual.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        ></i>Patent Details Individual</a>
                <a href="PatentInfo.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        ></i>Patent Info</a>
