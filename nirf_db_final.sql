...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2023 at 11:22 AM
...
INSERT INTO `department_master` (`A_YEAR`, `DEPT_ID`, `DEPT_NAME`, `HOD_NAME`, `ADDRESS`, `EMAIL`, `PASS_WORD`) VALUES
('2023', 1, 'IT', 'AK', 'MUM', 'KAH', 'AS'),
('2023', 2, 'GERMAN', 'AKSHAY', 'MUMBAI', 'KAHSHA', 'ASAS');
...
CREATE TABLE `emp_details` (
  ...
  `TYPE_OF_IND` tinyint(1) NOT NULL,
  `COMPANY` varchar(255) NOT NULL,
  `LOCATION` varchar(255) NOT NULL,
  `EMAIL_ID` varchar(255) NOT NULL,
  `PHONE` int(11) NOT NULL,
  `TYPE_INDIAN_FOREIGN` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `faculty_details` (
  ...
  `FACULTY_EXP` tinyint(1) NOT NULL,
  `CURR_WORKING` tinyint(1) NOT NULL,
  `ASSOC_TYPE` varchar(255) NOT NULL,
  `EMAIL_ID` varchar(255) NOT NULL,
  `MOBILE_NUM` int(11) NOT NULL,
  `NAME_OF_AWARD` varchar(255) NOT NULL,
  `LEVEL_OF_AWARD` varchar(255) NOT NULL,
  `NAME_OF_AWARD_AGENCY` varchar(255) NOT NULL,
  `ADD_OF_AWARD_AGENCY` varchar(255) NOT NULL,
  `YEAR_OF_RECEIVED_AWARD` year(4) NOT NULL,
  `EMAIL_OF_AGENCY` varchar(255) NOT NULL,
  `CONTACT_OF_AGENCY` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `patent_details` (
  `A_YEAR` year(4) NOT NULL,
  `DEPT_ID` int(11) NOT NULL,
  `PATENT_APPLICATION_NO` int(11) NOT NULL,
  `STATUS_OF_PATENT` text NOT NULL,
  `INVENTOR_NAME` text NOT NULL,
  `TITLE_OF_PATENT` text NOT NULL,
  `APPLICANT_NAME` text NOT NULL,
  `PATENT_FILED` date NOT NULL,
  `PATENT_PUBLISHED_DATE` date NOT NULL,
  `PATENT_GRANTED_DATE` date NOT NULL,
  `PATENT_PUBLISHED_NUMBER` int(11) NOT NULL,
  `PATENT_GRANTED_NUMBER` int(11) NOT NULL,
...
CREATE TABLE `patent_info` (
  `A_YEAR` year(4) NOT NULL,
  `DEPT_ID` int(11) NOT NULL,
  `NO_OF_PATENT_FILLED_1_YEAR` int(11) NOT NULL,
  `NO_OF_PATENT_FILLED_2_YEAR` int(11) NOT NULL,
  `NO_OF_PATENT_FILLED_3_YEAR` int(11) NOT NULL,
  `NO_OF_PATENT_PUBLISHED_1_YEAR` int(11) NOT NULL,
  `NO_OF_PATENT_PUBLISHED_2_YEAR` int(11) NOT NULL,
  `NO_OF_PATENT_PUBLISHED_3_YEAR` int(11) NOT NULL,
  `NO_OF_PATENT_GRANTED_1_YEAR` int(11) NOT NULL,
  `NO_OF_PATENT_GRANTED_2_YEAR` int(11) NOT NULL,
  `NO_OF_PATENT_GRANTED_3_YEAR` int(11) NOT NULL,
  `TOTAL_AMT_GRANTED` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `department_master`
  ADD PRIMARY KEY (`A_YEAR`,`DEPT_ID`);
...
--
-- Indexes for table `inter_faculty`
--
ALTER TABLE `inter_faculty`
  ADD KEY `A_YEAR` (`A_YEAR`,`DEPT_ID`);
...
--
ALTER TABLE `academic_peers`
  ADD CONSTRAINT `academic_peers_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`);

--
-- Constraints for table `consultancy_projects`
--
ALTER TABLE `consultancy_projects`
  ADD CONSTRAINT `consultancy_projects_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`);
...
--
ALTER TABLE `emp_details`
  ADD CONSTRAINT `emp_details_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`);

--
-- Constraints for table `exec_dev`
--
ALTER TABLE `exec_dev`
  ADD CONSTRAINT `exec_dev_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`);

--
-- Constraints for table `faculty_count`
--
ALTER TABLE `faculty_count`
  ADD CONSTRAINT `faculty_count_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `faculty_details` (`A_YEAR`, `DEPT_ID`);

--
-- Constraints for table `faculty_details`
--
ALTER TABLE `faculty_details`
  ADD CONSTRAINT `faculty_details_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`);
...
--
-- Constraints for table `inter_faculty`
--
ALTER TABLE `inter_faculty`
  ADD CONSTRAINT `inter_faculty_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `academic_peers` (`A_YEAR`, `DEPT_ID`);

--
-- Constraints for table `online_education_details`
--
ALTER TABLE `online_education_details`
  ADD CONSTRAINT `online_education_details_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`);

--
-- Constraints for table `patent_details`
--
ALTER TABLE `patent_details`
  ADD CONSTRAINT `patent_details_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`);

--
-- Constraints for table `patent_info`
--
ALTER TABLE `patent_info`
  ADD CONSTRAINT `patent_info_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`);

--
-- Constraints for table `phd_details`
--
ALTER TABLE `phd_details`
  ADD CONSTRAINT `phd_details_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`);

--
-- Constraints for table `placement_details`
--
ALTER TABLE `placement_details`
  ADD CONSTRAINT `placement_details_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`),
...
--
ALTER TABLE `research_staff`
  ADD CONSTRAINT `research_staff_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`);

--
-- Constraints for table `salary_details`
--
ALTER TABLE `salary_details`
  ADD CONSTRAINT `salary_details_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`),
...
--
ALTER TABLE `sponsored_project_details`
  ADD CONSTRAINT `sponsored_project_details_ibfk_1` FOREIGN KEY (`A_YEAR`,`DEPT_ID`) REFERENCES `department_master` (`A_YEAR`, `DEPT_ID`);
COMMIT;
